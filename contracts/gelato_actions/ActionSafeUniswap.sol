...
contract ActionSafeUniswap is GelatoActionsStandard {
    ...
    constructor(address _uniswapRouter, address _tokenConversion, uint256 _slippageFactor) public {
        ...
        returns (uint256)
    {
        ...
        uint256 minOut = tokenConversion.minimumOut(_amountIn, _path[0], _path[_path.length-1], slippageFactor);
